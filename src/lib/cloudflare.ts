...
export type AssetManagerEnv = CloudflareEnv & {
  ...
  ASSET_MANAGER_DEMO_MODE?: string;
  ASSET_MANAGER_DEMO_SESSION_TTL_HOURS?: string;
  ASSET_MANAGER_DEMO_MAX_FILE_BYTES?: string;
  ASSET_MANAGER_DEMO_MAX_SESSION_BYTES?: string;
  ASSET_MANAGER_DEMO_MAX_SESSION_ASSETS?: string;
